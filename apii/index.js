...
const aboutInfo = {
  name: "TrashTrack",
  Tentang_Trashtrack: "Berawal dari rasa kecintaan kami terhadap alam/lingkungan yang kemudian berhimpun dalam sebuah komunitas pecinta alam, maka kami mencoba mengimplementasikan kecintaan kami pada lingkungan melalui teknologi yang pastinya kedepan teknologi akan menjadi platform utama dalam berbagai lini sektor. Permasalahan sampah saat ini masih menjadi masalah yang sangat serius karena ini yang akan kita wariskan kepada anak cucu kita, minimnya pemahaman memilah dan memilih sampah organik juga anorganik masih menjadi PR besar hari ini karena dalam setiap sampah itu memiliki potensi besar sampah tersebut dapat terurai atau harus menunggu jutaan tahun untuk terurai. Kami hadir menawarkan solusi yang akan memudahkan setiap pengguna jasa kami untuk dapat mengatasi masalah sampah dilingkungannya yaitu dengan cara memilah dan memilih sampah anorganik sebagai langkah awal kita semua dalam menjaga lingkungan.",
  Visi_dan_Misi: "Meningkatkan Kesadaran Lingkungan, Memperbaiki Manajemen Sampah, Meningkatkan Partisipasi Masyarakat",
};
