...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _submitReport(BuildContext context) async {
    ...
    final uri = Uri.parse('http://192.168.43.75:3000/api/reportTrash');
        ...
        child: Padding(
          ...
          child: Form(
            ...
            child: ListView(
              children: [
                Card(
                  elevation: 8, // Tinggi shadow card
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        TextFormField(
                          decoration:
                              InputDecoration(labelText: 'Lokasi Sampah'),
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                        ...
                        TextFormField(
                          decoration:
                              InputDecoration(labelText: 'Kategori Sampah'),
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                        ...
                        TextFormField(
                          decoration: InputDecoration(
                              labelText: 'Informasi Penjemputan'),
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                        ...
                        TextFormField(
                          decoration:
                              InputDecoration(labelText: 'Informasi Tambahan'),
                          validator: (value) {
                            if (value == null || value.isEmpty) {
