...
import 'navtap.dart'; // Make sure the file name for NavTap is correct
...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _login() async {
    final response = await http.post(
      Uri.parse('http://192.168.43.75:3000/api/login'),
    ...
    if (response.statusCode == 200) {
      ...
      if (data['status']) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => NavTap(), // Navigate to the main page
          ),
        );
      } else {
        setState(() {
            ...
            child: Card(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Image.asset(
                      'images/sampah.png', // Replace with the path to your logo
                      height: 100,
                    ),
                    SizedBox(height: 20),
                    TextField(
